...
import com.hoioy.jiayin.seucrity.MiniAppJwtWebSecurityConfigurerAdapter;
...
public class MiniSecurityConfig extends MiniAppJwtWebSecurityConfigurerAdapter {
    @Autowired
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().filterSecurityInterceptorOncePerRequest(true)
                .antMatchers("/auth/**", "/auth", "/captcha", "/error","/wx/**").permitAll()
...
//        http.addFilterBefore(miniAppAuthorizationTokenFilter(), MiniAppAuthorizationTokenFilter.class);
