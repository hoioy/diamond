...
//			userInfoDTO.setRoles(roles);
			...
			if (userInfoDTO.getId() == null) {
				userId = iUserInfoService.save(userInfoDTO).getId();
			} else {
				userId = iUserInfoService.update(userInfoDTO).getId();
			}
...
//			System.out.println(success);
	...
	public void findByLoginName() {
		String id = iUserInfoService.findIdByLoginName("ceshiLoginName");
	...
	public void Save() {
		...
		String id = iUserInfoService.save(userInfoDTO).getId();
		System.out.println(id);
	...
	public void update() {
		...
		String id = iUserInfoService.update(userInfoDTO).getId();
		System.out.println(id);
