        ...
        <el-card>
            <el-col :span="24">
                <el-form :model="queryCriteria" label-width="150px">
                    ...
                    <el-col :span="8">
                        <el-form-item label="剩余次数:" prop="number">
                            <el-input v-model="queryCriteria.number"   placeholder=" 请输入剩余次数"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <flex-center>
...
import * as JiayinMsgCountAPI from '@src/demo/api/JiayinMsgCount'
import add from './add'
