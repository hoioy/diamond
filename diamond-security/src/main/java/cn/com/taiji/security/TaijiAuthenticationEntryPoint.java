...
public class TaijiAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint{
	public TaijiAuthenticationEntryPoint(String loginFormUrl) {
		super(loginFormUrl);
		// TODO Auto-generated constructor stub
	}

	private static final Log logger = LogFactory.getLog(TaijiAuthenticationEntryPoint.class);
