 ...
 *
 */
public class DiamondFailureHandler implements AuthenticationFailureHandler {

    private static final Log log = LogFactory.getLog(DiamondFailureHandler.class);
    ...
    public DiamondFailureHandler() {
    }

    public DiamondFailureHandler(String defaultFailureUrl) {
