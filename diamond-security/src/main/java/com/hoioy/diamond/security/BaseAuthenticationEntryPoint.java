...
public class BaseAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint{
	public BaseAuthenticationEntryPoint(String loginFormUrl) {
		super(loginFormUrl);
		// TODO Auto-generated constructor stub
	}

	private static final Log logger = LogFactory.getLog(BaseAuthenticationEntryPoint.class);
