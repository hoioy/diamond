...
public class BaseAccessDeniedHandler implements AccessDeniedHandler {
	private String errorPage;
	 static Logger logger = LoggerFactory.getLogger(BaseAccessDeniedHandler.class);
	public BaseAccessDeniedHandler() {
	}
 
	public BaseAccessDeniedHandler(String errorPage) {
