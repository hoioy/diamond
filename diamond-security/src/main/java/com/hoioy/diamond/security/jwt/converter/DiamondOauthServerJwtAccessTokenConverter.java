 ...
 */
public class DiamondOauthServerJwtAccessTokenConverter extends AbstractCustomJwtAccessTokenConverter {
    private JwtDecoder jwtDecoder;

    final String EXP = "exp";

    public DiamondOauthServerJwtAccessTokenConverter() {
    }

    public DiamondOauthServerJwtAccessTokenConverter(JwtDecoder jwtDecoder) {
