...
public class DiamondAccessDeniedHandler implements AccessDeniedHandler {
	private String errorPage;
	 static Logger logger = LoggerFactory.getLogger(DiamondAccessDeniedHandler.class);
	public DiamondAccessDeniedHandler() {
	}
 
	public DiamondAccessDeniedHandler(String errorPage) {
