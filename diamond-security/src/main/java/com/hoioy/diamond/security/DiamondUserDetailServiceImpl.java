 ...
 */
public abstract class DiamondUserDetailServiceImpl implements UserDetailsService {
    public abstract DiamondUserDTO findDiamondUserDTOByLoginName(String loginName);
    ...
    public UserDetails loadUserByUsername(String loginName)
        ...
        DiamondUserDTO user = findDiamondUserDTOByLoginName(loginName);
        if (user == null) {
        ...
        DiamondUser userdetail = new DiamondUser(user, user.getLoginName(), user.getPassword(),
