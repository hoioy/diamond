  ...
  <div>
    ...
    <el-card>
      ...
      <el-form ref="form" :model="form" :rules="rules" :label-width="labelWidth">
        ...
        <el-form-item label="路由路径（path）" prop="menuDesc">
        ...
        <el-form-item label="组件路径（component）" prop="menuUrl">
        ...
        <el-form-item label="菜单分类" prop="menuClassify">
          <el-select v-model="form.menuClassify" placeholder="添加分类" clearable filterable>
        ...
        <el-form-item label="按钮权限ID" prop="authorityId">
