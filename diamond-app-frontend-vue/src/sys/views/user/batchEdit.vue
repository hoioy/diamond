      ...
      <template slot="header">
        <button-right>
          ...
          <template slot="button">
            <el-button type="primary" @click="submitUserRoleHandler()">
              保存
            </el-button>
          </template>
        </button-right>
    ...
    <el-card>
      ...
      <template slot="header">
        <button-right>
          部门信息
          <template slot="button">
            <el-button type="primary" @click="submitUserDeptHandler()">
              保存
            </el-button>
          </template>
        </button-right>
    ...
    <el-card>
      <template slot="header">
        <button-right>
          用户分组信息
          <template slot="button">
            <el-button type="primary" @click="submitUserGroupHandler()">
              保存
            </el-button>
          </template>
        </button-right>
...
export default {
  ...
  activated() {
    ...
    GroupAPI.queryAllGroups().then(data => {
