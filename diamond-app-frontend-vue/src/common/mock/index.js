...
//  系统设置相关---日志
// Mock.mock(/\/system\/log\/query/all/, 'post', logAPI.queryAll)
// Mock.mock(/\/system\/log\/query-page/, 'post', logAPI.queryPage)
// Mock.mock(/\/system\/log\/del/, 'get', logAPI.del)
...
// Mock.mock(/\/system\/menu\/add/, 'post', menuAPI.add)
// Mock.mock(/\/system\/menu\/del/, 'get', menuAPI.del)
// Mock.mock(/\/system\/menu\/query/all/, 'post', menuAPI.queryAll)
// Mock.mock(/\/system\/menu\/query-by-id/, 'get', menuAPI.queryById)
// Mock.mock(/\/system\/menu\/edit/, 'post', menuAPI.edit)
// Mock.mock(/\/system\/menu\/sync/, 'post', menuAPI.sync)
