<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      <div class="pic-404">
        <img class="pic-404__parent" src="@/assets/images/401.jpg">
      ...
      <div class="bullshit">
        ...
        >
          ...
          <div class="bullshit__headline" style="padding-top: 200px">
            401权限不足
          </div>
          <div class="bullshit__info">
  ...
  watch: {
    themecolor: {
      handler() {
        ...
        this.curThemeColor = '#' + this.themecolor
      }
    }
  },
  activated() {
