...
import com.hoioy.diamond.sys.domain.RoleUserRepository;
...
@Service
public class RoleUserServiceImpl extends BaseJoinServiceImpl<RoleUserRepository, RoleUser, RoleUserJoinDTO> implements IRoleUserService<RoleUser> {
    ...
    public void saveRoleUsers(String[] userIds, String preUserIds, String roleId) {
        String joinUsersIDs = StringUtils.join(userIds, ",");
