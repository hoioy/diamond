...
@Service
public class UserGroupUserServiceImpl extends BaseJoinServiceImpl<UserGroupUserRepository, UserGroupUser, UserGroupUserJoinDTO> implements IUserGroupUserService<UserGroupUser> {

    @Override
    public List<String> findGroupIdsByUserIds(List<String> userIds) {
        return iBaseRepository.findGroupIdsByUserIds(userIds);
    }
}