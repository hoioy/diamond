...
```
在TDF上展示效果图 
![](http://192.168.99.76:8083/upload/2d024f1caae94daabe4475d0a34fd45c_-_图片.png)
...
![](http://192.168.99.76:8083/upload/6ef07708062e4a05a3b213ca3525a82f_-_图片.png)
### 1.4 Hamburiger组件
...
```
TDF中的效果
![](http://192.168.99.76:8083/upload/9c6cb62059674b269e0bbb7d4d4c7df0_-_图片.png)
滚动条布局效果。
...
![](http://192.168.99.76:8083/upload/2cd9e89f34554f48971d40962ef318c1_-_图片.png)
![](http://192.168.99.76:8083/upload/4fa5f8c46cba431abbd393952a5460d1_-_图片.png)
```javascript
<template>
  <div class="full">
    <slot/>
...
```javascript
 <template slot-scope="scope">
            {{ scope.row.createdDate | parseTime1 }}
          </template>
```
显示成我们想要的时间格式。
![](http://192.168.99.76:8083/upload/b98255cfc1674409af6436e9b126523a_-_图片.png)
eg.对性别的转译
![](http://192.168.99.76:8083/upload/f186de5c5002418c9766be696614f525_-_图片.png)
### 2.4.formItemViews组件
该组件是对form表单项的封装。
```javascript
...
```
显示效果
![](http://192.168.99.76:8083/upload/34442faeec2647b3a2cd4fb5d4b5e4d2_-_图片.png)
...
```
组件效果
![](http://192.168.99.76:8083/upload/efd3d3d6a67c4bb9916ae97fe1d28616_-_图片.png)
### 2.6.selects组件
该组件主要是对左右布局的封装。
```javascript
<template>
...
```
组件效果
![](http://192.168.99.76:8083/upload/96cc3e4bfa4d49e6b622bf84bf653bcb_-_图片.png)


以上是对TDF所有组件的介绍，您有什么问题可以随时与我们联系，感谢您对TDF的支持。