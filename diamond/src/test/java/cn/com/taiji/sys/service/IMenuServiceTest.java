...
public class IMenuServiceTest {
	...
	public void Save() {
		...
		String id = iMenuService.save(menuDTO);
	...
	public void update() {
		...
		String id = iMenuService.update(menuDTO);
		System.out.println(id);
	...
	public void findAll() {
		...
		List<MenuDTO> list = iMenuService.findAll();
	...
	public void findMenusByParentId() {
		...
		List<MenuDTO> listTree = iMenuService.findMenusByParentId("90a127ce319d5d93b3b49c697cfa138f");
