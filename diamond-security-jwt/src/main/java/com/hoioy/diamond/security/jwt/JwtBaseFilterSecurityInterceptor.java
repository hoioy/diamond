 ...
 */
public class JwtBaseFilterSecurityInterceptor extends AbstractSecurityInterceptor
        implements Filter {
...
//		}
        ...
        if (authenticated != null) {
            if (authenticated.getPrincipal() != null) {
                if (authenticated.getPrincipal() instanceof BaseSecurityUser) {
                    BaseSecurityUser user = ((BaseSecurityUser) authenticated.getPrincipal());
                    CommonUserDTO userInfoDto = user.getUserInfoDto();//fisMetadataSource.findUserDtoByLoginName(user.getUsername());
                    if (userInfoDto != null) {
    ...
    public void setMetadataSource(BaseSecurityMetadataSource fisMetadataSource) {
