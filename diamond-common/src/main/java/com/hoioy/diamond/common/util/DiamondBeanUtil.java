...
public class DiamondBeanUtil {
    public static DiamondBeanUtil getInstance() {
        return DiamondBeanUtilHolder.instance;
    }
    ...
    private static class DiamondBeanUtilHolder {
        private static DiamondBeanUtil instance = new DiamondBeanUtil();
    }
}
